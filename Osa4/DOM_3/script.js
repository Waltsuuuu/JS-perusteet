...
/* Luo toiminnallisuus, jossa syötekentän arvo näytetään jatkuvasti ja päivitetään omalla alueellaan 
    sivulla käyttäjän kirjoittaessa, käyttäen onchange-tapahtumaa. */
...
document.getElementById("text").oninput = function () {
    let usrText = document.getElementById("text").value
    document.getElementById("displayText").innerHTML = usrText;
}
